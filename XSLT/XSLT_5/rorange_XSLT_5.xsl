...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <html>
            <head>
                <title>Remington Orange - XSLT 4</title>
                <link rel="stylesheet" type="text/css" href="style.css"/> 
            </head>
            <body>
                <h1> Remington Orange - Sonic - XSLT 4</h1>
    ...
    <xsl:template match="div[@type='page']" mode="toc">
        ...
        <tr>
            ...
            <td>Panels:
           <ul>
               <xsl:apply-templates select=".//cbml:panel"></xsl:apply-templates>
           </ul> 
           </td>
        </tr>
    </xsl:template>
    
    <xsl:template match="cbml:panel"></xsl:template>
